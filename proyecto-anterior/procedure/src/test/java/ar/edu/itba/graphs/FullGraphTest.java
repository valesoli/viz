...
import ar.edu.itba.graph.impl.FullGraph;
...
public class FullGraphTest extends GraphTest {

    private FullGraph graph;

    @BeforeAll
    void setGraph() {
        this.graph = new FullGraph(
                this.db,
                "interval",
                "interval",
    ...
    void testGetRelationshipsFromNode() {
        ...
        assertThat(edges)
                ...
                .contains(
                        ...
                        new Interval(Year.parse("1960"), Year.parse("2020"))
                );
    }
