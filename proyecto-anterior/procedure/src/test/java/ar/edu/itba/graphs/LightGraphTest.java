...
import ar.edu.itba.graph.impl.LightGraph;
...
public class LightGraphTest extends GraphTest {

    private LightGraph graph;

    @BeforeAll
    void setGraph() {
        this.graph = new LightGraph(
                this.db,
                "MATCH (n:Object {title: 'Airport'})-[e:Flight]->(m:Object {title: 'Airport'})" +
                        "RETURN id(n) as source, e.interval as weight, id(m) as target",
