...
public class SocialNetworkQueryDatetimeIT extends IntegrationTest {

    public SocialNetworkQueryDatetimeIT() {
        super("datetime.cypher");
    }
    ...
    public void testCPathOfLength3() {
        ...
        runQuery(compiledQuery, (result) -> {
            ...
            assertThat(records)
                    ...
                    .containsExactlyInAnyOrder(
                            "2015-01-01 00:00 — 2017-12-31 23:59",
                            "2010-01-01 00:00 — 2017-12-31 23:59"
                    );
        });
    }
    ...
    public void testCPathOfLength3WithInterval() {
        String compiledQuery = compileQuery(
                "SELECT p.path[0].attributes.Name as from, p.path[3].attributes.Name as to, p.interval as interval\n" +
                        "MATCH (n:Person),(n2:Person),p = cPath((n)-[:Friend*3]->(n2), '2010-03-07 23:35', '2014-03-08 15:25')");
